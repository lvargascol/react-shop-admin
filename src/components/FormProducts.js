...
//URL de imagen temporal, mientras resuelvo como convertir un archivo en un enlace
const URL_IMAGE = 'https://i.pinimg.com/originals/cf/ca/5b/cfca5b6f7cea1689e5ad970e265479ff.jpg';
...
export default function FormProduct({ setOpen, setAlert, product }) {
  ...
  const handleSubmit = (event) => {
    ...
    const data = {
      ...
      // images: [formData.get('images').name],   //Si se puediera subir directamente el archivo
      images: [URL_IMAGE],
    };
